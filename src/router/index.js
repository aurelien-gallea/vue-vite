...
const routes = [
    {path: '/', component: HomeView, name: 'home', alias : ['/accueil', '/home'], meta : { title: "Page d'accueil"} },
    ...
    {path: '/personne/:id', component: PersonneDetails, name: 'personne-details', props: true},
